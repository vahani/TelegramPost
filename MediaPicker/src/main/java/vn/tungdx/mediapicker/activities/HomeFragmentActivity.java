	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent() != null
			...
			if (getIntent().getBooleanExtra("image", false)) {
				...
				setHeaderBarCameraBackground(getResources().getDrawable(
						R.drawable.selector_camera_button));

				headerBarCamera
						.setTag(getResources().getString(R.string.image));

				Bundle bundle = new Bundle();
				bundle.putString("name", getIntent().getStringExtra("name"));
				mTabHost.addTab(
						mTabHost.newTabSpec("tab1").setIndicator(
								getResources().getString(R.string.images_tab)
				...
				headerBarCamera
						.setTag(getResources().getString(R.string.video));
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			...
			public void onTabChanged(String tabId) {
				...
				if (tabId.equalsIgnoreCase("tab1")) {
					...
					setHeaderBarCameraBackground(getResources().getDrawable(
							R.drawable.selector_camera_button));
					headerBarCamera.setTag(getResources().getString(
							R.string.image));
		...
		headerBarCamera.setPadding(convertDipToPixels(15),
				convertDipToPixels(15), convertDipToPixels(15),
		...
		public void onClick(View view) {
			if (view == headerBarCamera) {
				...
				if (view.getTag().toString()
						.equals(getResources().getString(R.string.video))) {
					Intent intent = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
					fileUri = getOutputMediaFileUri(MediaChooserConstants.MEDIA_TYPE_VIDEO); // create
																								// a
																								// file
																								// to
																								// save
					...
					fileUri = getOutputMediaFileUri(MediaChooserConstants.MEDIA_TYPE_IMAGE); // create
																								// a
																								// file
																								// to
																								// save
